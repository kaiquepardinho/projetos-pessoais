var arcimagem = ["https://media.fstatic.com/BiSBGzp0D0YiB-nxB5AKteKVZ2w=/268x386/smart/media/movies/covers/2011/07/ac40542608f1ce6b2872abe76355ef92.jpg" , 
...
var arcnome = ["East Blue" , "Alabasta" ,  "Skypea" ,  "Ennies Lobby" ,  "Thriller Bark" ,  "Arquipélago de Sabaody" ,  "Impel Down" ,  "Marineford" , 
"Ilha dos Tritões" ,  "Punk Hazard" ,  "Dressrosa" ,  "Zou" ,  "Ilha do Bolo Inteiro" ,  "País de Wano"]

var arclink = ["https://www.anitube.site/765/" ,  "https://www.anitube.site/1221/" ,  "https://www.anitube.site/2074/" , 
...
for (let i = 0; i < arcimagem.length; i++) {
    document.write("<div class='itens'>", "<a href=", arclink[i], " target='_blank' >", `<img class='${(i == 6)?"poster impel":"poster"}'  src=${arcimagem[i]}  >`, 
    "<p class='nomes'>", arcnome[i], "</p>", "</a>", "</div>")
  }